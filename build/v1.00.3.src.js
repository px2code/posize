...
function createParser(matcher, replacer) {
  ...
  return function (string) {
    ...
    if (typeof string !== 'string') {
      throw new TypeError("expected an argument of type string, but got ".concat(typeof styleObj === "undefined" ? "undefined" : _typeof(styleObj)));
...
var camelToKebab = (0, _createParser.default)(/[A-Z]/, function (match) {
  return "-".concat(match.toLowerCase());
});
exports.camelToKebab = camelToKebab;
var snakeToKebab = (0, _createParser.default)(/_/, function () {
  return '-';
...
function objToString(styleObj) {
  var parser = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _parsers.camelToKebab;

  if (!styleObj || _typeof(styleObj) !== 'object' || Array.isArray(styleObj)) {
    throw new TypeError("expected an argument of type object, but got ".concat(_typeof(styleObj)));
  }

  var lines = Object.keys(styleObj).map(function (property) {
    return "".concat(parser(property), ": ").concat(styleObj[property], ";");
  });
  return lines.join('\n');
}
...
exports.Posize = void 0;

var _litElement = require("lit-element");

var _styleObjectToCssString = _interopRequireDefault(require("./style-object-to-css-string"));
...
var styles = {
  ...
  area: {
    ...
    position: 'relative',
    width: '100%',
    // fit box, it is necessary because child need refer parent size
...
function (_LitElement) {
  _inherits(Posize, _LitElement);

  var _super = _createSuper(Posize);

  function Posize() {
    _classCallCheck(this, Posize);
  ...
  _createClass(Posize, [{
    key: "genCssStyle",
    value: function genCssStyle(baseClass, cssObject) {
      var oneLevelCssObject = {};
      var css = '';

      for (var _i = 0, _Object$entries = Object.entries(cssObject); _i < _Object$entries.length; _i++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
            key = _Object$entries$_i[0],
            value = _Object$entries$_i[1];

        if (_typeof(value) === "object") {
          css = "".concat(css, "\n ").concat(this.genCssStyle("".concat(baseClass, " ").concat(key), value));
        } else {
          oneLevelCssObject[key] = value;
        }
      }

      css = "".concat(baseClass, " {").concat((0, _styleObjectToCssString.default)(oneLevelCssObject), "}\n ").concat(css);
      return css;
    }
  }, {
    key: "genTrackStyles",
    value: function genTrackStyles(x, y, zIndex, display) {
      var result = {};

      if (x && y) {
        result = {
          grid: "".concat(y, " / ").concat(x)
        };
      }
    ...
    key: "genAreaStyles",
    value: function genAreaStyles(x, y) {
      if (!x || !y) return {};
      var v = Math.round(y.replace(rep, ',').split(split).length / 2);
      var h = Math.round(x.replace(rep, ',').split(split).length / 2);
      return {
        gridArea: "".concat(v, " / ").concat(h, " / ").concat(v, " / ").concat(h)
      };
    }
  }, {
    key: "genGridStyles",
    value: function genGridStyles(x, y, zIndex, display, maxx, maxy, xxxlx, xxxly, xxlx, xxly, xlx, xly, lgx, lgy, mdx, mdy, smx, smy, xsx, xsy, xxsx, xxsy, tnx, tny, maxZIndex, xxxlZIndex, xxlZIndex, xlZIndex, lgZIndex, mdZIndex, smZIndex, xsZIndex, xxsZIndex, tnZIndex, maxDisplay, xxxlDisplay, xxlDisplay, xlDisplay, lgDisplay, mdDisplay, smDisplay, xsDisplay, xxsDisplay, tnDisplay) {
      return {
    ...
    value: function render() {
      var _this$x = this.x,
          x = _this$x === void 0 ? '1fr 1fr 1fr' : _this$x,
          _this$y = this.y,
          y = _this$y === void 0 ? '1fr 1fr 1fr' : _this$y,
          absolute = this.absolute,
          debug = this.debug;
      var gridStyles = this.genGridStyles(x, y, this['z-index'], this['display'] || 'show', this['max-x'], this['max-y'], this['xxxl-x'], this['xxxl-y'], this['xxl-x'], this['xxl-y'], this['xl-x'], this['xl-y'], this['lg-x'], this['lg-y'], this['md-x'], this['md-y'], this['sm-x'], this['sm-y'], this['xs-x'], this['xs-y'], this['xxs-x'], this['xxs-y'], this['tn-x'], this['tn-y'], this['max-z-index'], this['xxxl-z-index'], this['xxl-z-index'], this['xl-z-index'], this['lg-z-index'], this['md-z-index'], this['sm-z-index'], this['xs-z-index'], this['xxs-z-index'], this['tn-z-index'], this['max-display'], this['xxxl-display'], this['xxl-display'], this['xl-display'], this['lg-display'], this['md-display'], this['sm-display'], this['xs-display'], this['xxs-display'], this['tn-display']);
      var track = (0, _styleObjectToCssString.default)(absolute ? styles.absTrack : styles.relTrack);
      var area = (0, _styleObjectToCssString.default)(styles.area);
      var debugTrack = config.debug || debug ? (0, _styleObjectToCssString.default)(styles.debugTrack) : '';
      var debugArea = config.debug || debug ? (0, _styleObjectToCssString.default)(styles.debugArea) : '';
      return (0, _litElement.html)(_templateObject(), track, debugTrack, (0, _styleObjectToCssString.default)(gridStyles.track), area, debugArea, (0, _styleObjectToCssString.default)(gridStyles.area), (0, _styleObjectToCssString.default)(gridStyles.maxTrack), (0, _styleObjectToCssString.default)(gridStyles.maxArea), (0, _styleObjectToCssString.default)(gridStyles.xxxlTrack), (0, _styleObjectToCssString.default)(gridStyles.xxxlArea), (0, _styleObjectToCssString.default)(gridStyles.xxlTrack), (0, _styleObjectToCssString.default)(gridStyles.xxlArea), (0, _styleObjectToCssString.default)(gridStyles.xlTrack), (0, _styleObjectToCssString.default)(gridStyles.xlArea), (0, _styleObjectToCssString.default)(gridStyles.lgTrack), (0, _styleObjectToCssString.default)(gridStyles.lgArea), (0, _styleObjectToCssString.default)(gridStyles.mdTrack), (0, _styleObjectToCssString.default)(gridStyles.mdArea), (0, _styleObjectToCssString.default)(gridStyles.smTrack), (0, _styleObjectToCssString.default)(gridStyles.smArea), (0, _styleObjectToCssString.default)(gridStyles.xsTrack), (0, _styleObjectToCssString.default)(gridStyles.xsArea), (0, _styleObjectToCssString.default)(gridStyles.xxsTrack), (0, _styleObjectToCssString.default)(gridStyles.xxsArea), (0, _styleObjectToCssString.default)(gridStyles.tnTrack), (0, _styleObjectToCssString.default)(gridStyles.tnArea), this['track-style'] ? this.genCssStyle(':host', JSON.parse(this['track-style'])) : '', this['area-style'] ? this.genCssStyle('.area', JSON.parse(this['area-style'])) : '');
    }
  }], [{
    key: "properties",
    get: function get() {
