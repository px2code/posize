...
function (_LitElement) {
  ...
  _createClass(Posize, [{
    ...
    key: "genGridStyles",
    value: function genGridStyles(x, y, zIndex, maxx, maxy, xxxlx, xxxly, xxlx, xxly, xlx, xly, lgx, lgy, mdx, mdy, smx, smy, xsx, xsy, maxZIndex, xxxlZIndex, xxlZIndex, xlZIndex, lgZIndex, mdZIndex, smZIndex, xsZIndex, maxDisplay, xxxlDisplay, xxlDisplay, xlDisplay, lgDisplay, mdDisplay, smDisplay, xsDisplay) {
      return {
    ...
    value: function render() {
      var _this$x = this.x,
          ...
          debug = this.debug;
      var gridStyles = this.genGridStyles(x, y, this['z-index'], this['max-x'], this['max-y'], this['xxxl-x'], this['xxxl-y'], this['xxl-x'], this['xxl-y'], this['xl-x'], this['xl-y'], this['lg-x'], this['lg-y'], this['md-x'], this['md-y'], this['sm-x'], this['sm-y'], this['xs-x'], this['xs-y'], this['max-z-index'], this['xxxl-z-index'], this['xxl-z-index'], this['xl-z-index'], this['lg-z-index'], this['md-z-index'], this['sm-z-index'], this['xs-z-index'], this['max-display'], this['xxxl-display'], this['xxl-display'], this['xl-display'], this['lg-display'], this['md-display'], this['sm-display'], this['xs-display']);
...
//# sourceMappingURL=/v1.00.src.js.map